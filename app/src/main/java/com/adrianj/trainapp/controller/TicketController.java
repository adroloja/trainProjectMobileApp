...
public class TicketController {
    ...
    public TicketController(Context context, final OnReceivedListener listener){

        this.context = context;
        this.listener = listener;
    }

    public void getTicketForStationAtoB(JSONObject jsonObject) throws JSONException {

        String url = Global.BASEURL + "searchTrain";
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try{
                            ...
                            if(listener != null){
                                ...
                                listener.onReceivedTicketList(ticketList);
                            }
    ...
    public interface OnReceivedListener{
        void onReceivedTicketList(List<Ticket> ticketList);
    }
}
